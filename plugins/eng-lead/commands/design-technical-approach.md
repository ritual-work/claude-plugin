...
Scope **Design Technical Approach** through the Eng Lead lens — a Ritual discovery
command that produces a **Technical Design Brief** (a decision-ready brief,
...
- Read the request through the **Eng Lead** lens and this job (**design-technical-approach**).
...
1. **Ritual MCP available** (`mcp__ritual__*` tools present)? → **use it.** Create
   an exploration for the request seeded with **jtbd `design-technical-approach`** under the
   **eng-lead** lens, focused on the Eng Lead sections below; walk discovery →
