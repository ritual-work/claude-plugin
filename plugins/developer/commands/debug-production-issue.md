...
Scope **Debug Production Issue** through the Developer lens. This is a Ritual
discovery command — it produces a **Debugging Brief** (a decision-ready
...
2. **Run the discovery, seeded with this job.** Create a Ritual exploration for
   the request above with **jtbd `debug-production-issue`** under the **developer** lens,
