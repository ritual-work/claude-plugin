...
Scope **Integrate Api** through the Developer lens. This is a Ritual
discovery command — it produces a **Integration Brief** (a decision-ready
...
2. **Run the discovery, seeded with this job.** Create a Ritual exploration for
   the request above with **jtbd `integrate-api`** under the **developer** lens,
