---
description: Scope "Build Technical Spike" as a Developer — produces a Technical Spike Brief (a decision-ready brief, not code).
---

# Developer: Build Spike

Scope **Build Technical Spike** through the Developer lens — a Ritual discovery
command that produces a **Technical Spike Brief** (a decision-ready brief,
...
- Read the request through the **Developer** lens and this job (**build-technical-spike**).
...
1. **Ritual MCP available** (`mcp__ritual__*` tools present)? → **use it.** Create
   an exploration for the request seeded with **jtbd `build-technical-spike`** under the
