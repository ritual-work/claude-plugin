...
Scope **Build Technical Spike** through the Developer lens. This is a Ritual
discovery command — it produces a **Technical Spike Brief** (a decision-ready
...
2. **Run the discovery, seeded with this job.** Create a Ritual exploration for
   the request above with **jtbd `build-technical-spike`** under the **developer** lens,
