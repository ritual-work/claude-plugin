...
Scope **Improve Performance** through the Developer lens. This is a Ritual
discovery command — it produces a **Performance Brief** (a decision-ready
...
2. **Run the discovery, seeded with this job.** Create a Ritual exploration for
   the request above with **jtbd `improve-performance`** under the **developer** lens,
