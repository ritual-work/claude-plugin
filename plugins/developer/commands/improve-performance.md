---
description: Scope "Improve Performance" as a Developer — produces a Performance Brief (a decision-ready brief, not code).
---

# Developer: Improve Performance

Scope **Improve Performance** through the Developer lens — a Ritual discovery
command that produces a **Performance Brief** (a decision-ready brief,
...
- Read the request through the **Developer** lens and this job (**improve-performance**).
...
1. **Ritual MCP available** (`mcp__ritual__*` tools present)? → **use it.** Create
   an exploration for the request seeded with **jtbd `improve-performance`** under the
