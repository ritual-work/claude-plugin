---
description: Scope "Create Docs Site" as a Developer — produces a Documentation Site Brief (a decision-ready brief, not code).
---

# Developer: Build Docs Site

Scope **Create Docs Site** through the Developer lens — a Ritual discovery
command that produces a **Documentation Site Brief** (a decision-ready brief,
...
- Read the request through the **Developer** lens and this job (**create-docs-site**).
...
1. **Ritual MCP available** (`mcp__ritual__*` tools present)? → **use it.** Create
   an exploration for the request seeded with **jtbd `create-docs-site`** under the
