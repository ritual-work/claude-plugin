...
Scope **Create Docs Site** through the Developer lens. This is a Ritual
discovery command — it produces a **Documentation Site Brief** (a decision-ready
...
2. **Run the discovery, seeded with this job.** Create a Ritual exploration for
   the request above with **jtbd `create-docs-site`** under the **developer** lens,
