...
Scope **Create Implementation Plan** through the Developer lens. This is a Ritual
discovery command — it produces a **Implementation Plan** (a decision-ready
...
2. **Run the discovery, seeded with this job.** Create a Ritual exploration for
   the request above with **jtbd `create-implementation-plan`** under the **developer** lens,
