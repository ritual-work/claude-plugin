---
description: Scope "Create Implementation Plan" as a Developer — produces a Implementation Plan (a decision-ready brief, not code).
---

# Developer: Plan Implementation

Scope **Create Implementation Plan** through the Developer lens — a Ritual discovery
command that produces a **Implementation Plan** (a decision-ready brief,
...
- Read the request through the **Developer** lens and this job (**create-implementation-plan**).
...
1. **Ritual MCP available** (`mcp__ritual__*` tools present)? → **use it.** Create
   an exploration for the request seeded with **jtbd `create-implementation-plan`** under the
