---
description: Scope "Prepare Release" as a Developer — produces a Release Readiness Brief (a decision-ready brief, not code).
---

# Developer: Prepare Release

Scope **Prepare Release** through the Developer lens — a Ritual discovery
command that produces a **Release Readiness Brief** (a decision-ready brief,
...
- Read the request through the **Developer** lens and this job (**prepare-release**).
...
1. **Ritual MCP available** (`mcp__ritual__*` tools present)? → **use it.** Create
   an exploration for the request seeded with **jtbd `prepare-release`** under the
