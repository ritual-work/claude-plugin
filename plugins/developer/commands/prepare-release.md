...
Scope **Prepare Release** through the Developer lens. This is a Ritual
discovery command — it produces a **Release Readiness Brief** (a decision-ready
...
2. **Run the discovery, seeded with this job.** Create a Ritual exploration for
   the request above with **jtbd `prepare-release`** under the **developer** lens,
