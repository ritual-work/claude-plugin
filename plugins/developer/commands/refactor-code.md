...
Scope **Refactor Code** through the Developer lens. This is a Ritual
discovery command — it produces a **Refactor Plan** (a decision-ready
...
2. **Run the discovery, seeded with this job.** Create a Ritual exploration for
   the request above with **jtbd `refactor-code`** under the **developer** lens,
