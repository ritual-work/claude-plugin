---
description: Scope "Refactor Code" as a Developer — produces a Refactor Plan (a decision-ready brief, not code).
---

# Developer: Refactor Code

Scope **Refactor Code** through the Developer lens — a Ritual discovery
command that produces a **Refactor Plan** (a decision-ready brief,
...
- Read the request through the **Developer** lens and this job (**refactor-code**).
...
1. **Ritual MCP available** (`mcp__ritual__*` tools present)? → **use it.** Create
   an exploration for the request seeded with **jtbd `refactor-code`** under the
