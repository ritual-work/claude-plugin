---
description: Scope "Add Tests" as a Developer — produces a Test Strategy Brief (a decision-ready brief, not code).
---

# Developer: Add Tests

Scope **Add Tests** through the Developer lens — a Ritual discovery
command that produces a **Test Strategy Brief** (a decision-ready brief,
...
- Read the request through the **Developer** lens and this job (**add-tests**).
...
1. **Ritual MCP available** (`mcp__ritual__*` tools present)? → **use it.** Create
   an exploration for the request seeded with **jtbd `add-tests`** under the
...
The full Test Strategy Brief composes 15 sections
