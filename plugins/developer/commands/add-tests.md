...
Scope **Add Tests** through the Developer lens. This is a Ritual
discovery command — it produces a **Test Strategy Brief** (a decision-ready
...
2. **Run the discovery, seeded with this job.** Create a Ritual exploration for
   the request above with **jtbd `add-tests`** under the **developer** lens,
