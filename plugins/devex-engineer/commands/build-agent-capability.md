---
description: Scope "Build Agent Capability" as a DevEx Engineer — produces a Feature Specification (Agentic Coding) (a decision-ready brief, not code).
---

# DevEx Engineer: Build Agent Capability

Scope **Build Agent Capability** through the DevEx Engineer lens — a Ritual discovery
...
- Read the request through the **DevEx Engineer** lens and this job (**build-agent-capability**).
...
1. **Ritual MCP available** (`mcp__ritual__*` tools present)? → **use it.** Create
   an exploration for the request seeded with **jtbd `build-agent-capability`** under the
