...
Scope **Build Agent Capability** through the DevEx Engineer lens. This is a Ritual
...
2. **Run the discovery, seeded with this job.** Create a Ritual exploration for
   the request above with **jtbd `build-agent-capability`** under the **devex-engineer** lens,
