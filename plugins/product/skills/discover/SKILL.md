...
description: >-
  ...
  opportunity, writing a customer pain-point brief, drafting a PRD, defining MVP
  scope, or prioritizing use cases. Routes the task to the right canonical Ritual
  job under the product lens, and degrades cleanly when Ritual isn't connected.
  Use when a product decision is ambiguous or the requirements aren't yet pinned
  down.
---
...
about the work and its outcome in their terms ("let's frame the opportunity
